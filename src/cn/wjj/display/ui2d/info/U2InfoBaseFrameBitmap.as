package cn.wjj.display.ui2d.info
{
	 ...
	 * @author GaGa
	 */
	public class U2InfoBaseFrameBitmap extends U2InfoBaseFrame 
	{
		/** 记录帧的显示对象 **/
		public var display:U2InfoBitmap;
		
		public function U2InfoBaseFrameBitmap(parent:U2InfoBaseInfo):void
		{
			super(parent);
			this.type = U2InfoType.baseFrameBitmap;
			display = new U2InfoBitmap(parent);
		}
		...
		{
			var o:U2InfoBaseFrameBitmap = new U2InfoBaseFrameBitmap(parent);
			copyThis(o, parent);
