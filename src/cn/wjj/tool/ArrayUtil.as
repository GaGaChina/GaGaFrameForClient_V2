package cn.wjj.tool
{
	public class ArrayUtil
	{
		 ...
		 * @param value
		 */
		public static function removeValueFromArray(a:Array, value:*):void
		{
			var i:int = a.lastIndexOf(value);
			while (i != -1) 
			{
				a.splice(i, 1);
				i = a.lastIndexOf(value, i);
			}
		}
		 ...
		 * @return
		 */
		public static function createRepeatItem(a:Array):Array
		{
			var newArray:Array = new Array();
		 ...
		 * 
		 */
		public static function createShare(a:Array, b:Array):Array
		{
		 ...
		 * @return 
		 */
		public static function randomArray(a:Array):Array
		{
			if (a.length == 0)
			{
				return new Array();
		 ...
		 * @return
		 */
		public static function moveItem(arr:Array, index:int, moveNum:int):Array
		{
			var out:Array = arr.slice();
			//当取值位置,比长度大的时候
		...
		/**
		 * 改变带入的Array的排序,并且输出被改变的列被改到的索引值
		 * @param arr
		 * @param index
		 * @param moveNum
		 * @return 
		 */
		public static function moveItemGetIndex(arr:Array, index:int, moveNum:int):int
		{
			//当取值位置,比长度大的时候
			if (moveNum == 0)
			{
